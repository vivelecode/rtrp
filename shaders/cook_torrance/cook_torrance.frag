...
void main (void)
{
    ...
    //const vec4  diffColor = vec4 ( 0.752, 0.752, 0.752, 1.0 );
    //const vec4  specColor = vec4 ( 0.788, 0.752, 0.733, 1.0 );
	
	//const vec4  diffColor = vec4 ( 0.252, 0.252, 0.252, 1.0 );
    //const vec4  specColor = vec4 ( 0.288, 0.252, 0.233, 1.0 );
